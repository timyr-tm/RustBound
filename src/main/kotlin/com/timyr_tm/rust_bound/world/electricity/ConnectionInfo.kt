...
data class ConnectionInfo(
    ...
    companion object {
        val CODEC: Codec<ConnectionInfo> = RecordCodecBuilder.create {
            instance -> instance
                .group(
                ...
                .apply(instance, ::ConnectionInfo)
        }

        val STREAM_CODEC: StreamCodec<ByteBuf, ConnectionInfo> = StreamCodec.composite(
    ...
    fun getConnectionPoint(level: LevelReader): ConnectionPointInfo? = getBlockEntity(level)?.getConnectionPoints()?.getOrDefault(name, null)
}